...
const User = list({
  ...
  fields: {
    ...
    authoredTeams: relationship({ ref: "Team.author", many: true }),
    managedTeams: relationship({ ref: "Team.managers", many: true }),
    ...
    userLevelsHistory: relationship({
      ref: "UserLevelHistory.user",
      many: true,
    }),
  },
